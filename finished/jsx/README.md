...
If you are familiar with HTML much of what is inside of the return statement will look familiar.
<br>This is JSX.
<br>Some immediate differences you may notice are the use of `className` versus `class`, and also the curly braces around
`logo`, which refers to the image that is being imported into this component at the top of the page.
<br> Example edits
