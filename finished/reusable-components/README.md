...
A reusable component allows you to re-use content or HTML structure that accepts unique content on different pages or locations on the same page throughout your site.

The advantage is ease of maintainability, there is only 1 file to update.
